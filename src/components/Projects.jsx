  ...
  return (
    <section id="projects" className="py-20 px-6 bg-slate-50">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-5 rounded-xl shadow hover:shadow-lg transition flex flex-col justify-between">
          <div>
            <img src="/images/quotes.png" alt="Project 3" className="rounded mb-4" />
            <h3 className="text-xl font-semibold">QUOTES-APP</h3>
            <p className="text-sm text-slate-600 mt-2">QUOTES-APP is a random quotes generator.Build with React, Tailwind CSS, etc.</p>
          </div>
          <div className="mt-4 flex flex-col gap-2">
